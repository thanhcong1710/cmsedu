...
class LMSAPIController
{
    ...
    public function createBranchLMS($branch_id)
    {
        ...
        if (ENVIRONMENT == 'product') {
            $url = env('LMS_API_URL', 'https://lms-vn.cmsedu.net') . "/api/v1/user/centerRegAction.do";
        } else {
            $url = env('LMS_API_URL', 'https://lms-vn.cmsedu.net') . "/api/v1/user/centerRegAction.do";
        }
        $method = 'POST';
    ...
    public function updateBranchLMS($branch_id)
    {
        ...
        if (ENVIRONMENT == 'product') {
            $url = env('LMS_API_URL', 'https://lms-vn.cmsedu.net') . "/api/v1/user/centerModAction.do";
        } else {
            $url = env('LMS_API_URL', 'https://lms-vn.cmsedu.net') . "/api/v1/user/centerModAction.do";
        }
        $method = 'POST';
    ...
    public function createTeacherLMS($teacher_id)
    {
        ...
        if (ENVIRONMENT == 'product') {
            $url = env('LMS_API_URL', 'https://lms-vn.cmsedu.net') . "/api/v1/user/teacherRegAction.do";
        } else {
            $url = env('LMS_API_URL', 'https://lms-vn.cmsedu.net') . "/api/v1/user/teacherRegAction.do";
        }
        $method = 'POST';
    ...
    public function updateTeacherLMS($teacher_id)
    {
        ...
        if (ENVIRONMENT == 'product') {
            $url = env('LMS_API_URL', 'https://lms-vn.cmsedu.net') . "/api/v1/user/teacherModAction.do";
        } else {
            $url = env('LMS_API_URL', 'https://lms-vn.cmsedu.net') . "/api/v1/user/teacherModAction.do";
        }
        $method = 'POST';
    ...
    public function createClassLMS($class_id)
    {
        ...
        if (in_array($class_info->product_id, [1, 2, 3, 100]) && 1 == 2) {
            ...
            if (ENVIRONMENT == 'product') {
                $url = env('LMS_API_URL', 'https://lms-vn.cmsedu.net') . "/api/v1/cntr/classRegAction.do";
            } else {
                $url = env('LMS_API_URL', 'https://lms-vn.cmsedu.net') . "/api/v1/cntr/classRegAction.do";
            }
            $method = 'POST';
    ...
    public function updateClassLMS($class_id, $pre_teacher_id = 0)
    {
        ...
        if (in_array($class_info->product_id, [1, 2, 3, 100]) && 1 == 2) {
            ...
            if (ENVIRONMENT == 'product') {
                $url = env('LMS_API_URL', 'https://lms-vn.cmsedu.net') . "/api/v1/cntr/classModAction.do";
            } else {
                $url = env('LMS_API_URL', 'https://lms-vn.cmsedu.net') . "/api/v1/cntr/classModAction.do";
            }
            $method = 'POST';
    ...
    public function createStudentLMS($contract_id)
    {
        ...
        if ($student_info && in_array($student_info->product_id, [1, 2, 3, 100]) && 1 == 2) {
            ...
            if (ENVIRONMENT == 'product') {
                $url = env('LMS_API_URL', 'https://lms-vn.cmsedu.net') . "/api/v1/cntr/studentRegAction.do";
            } else {
                $url = env('LMS_API_URL', 'https://lms-vn.cmsedu.net') . "/api/v1/cntr/studentRegAction.do";
            }
            $method = 'POST';
    ...
    public function updateStudentLMS($student_id, $from_class_id = 0, $is_branchTransfer = false)
    {
        ...
        if ($student_info && in_array($student_info->product_id, [1, 2, 3, 100])) {
            ...
            if (ENVIRONMENT == 'product') {
                $url = env('LMS_API_URL', 'https://lms-vn.cmsedu.net') . "/api/v1/cntr/studentModAction.do";
            } else {
                $url = env('LMS_API_URL', 'https://lms-vn.cmsedu.net') . "/api/v1/cntr/studentModAction.do";
            }
            $method = 'POST';
    ...
    public function updateListStudent($page)
    {
        ...
        $url = env('LMS_API_URL', 'https://lms-vn.cmsedu.net') . "/api/v1/cntr/getStudentList.do";
        $method = 'POST';
        $params = [
            "start" => 1000 * $page + 1,
            "length" => 1000,
    ...
    public function updateListClass($page)
    {
        ...
        $url = env('LMS_API_URL', 'https://lms-vn.cmsedu.net') . "/api/v1/cntr/getClassList.do";
        $method = 'POST';
        $params = [
            "start" => 1000 * $page + 1,
            "length" => 1000,
    ...
    public function updateListTeacher($page)
    {
        ...
        $url = env('LMS_API_URL', 'https://lms-vn.cmsedu.net') . "/api/v1/user/getTeacherList.do";
        $method = 'POST';
        $params = [
            "start" => 1000 * $page + 1,
            "length" => 1000,
