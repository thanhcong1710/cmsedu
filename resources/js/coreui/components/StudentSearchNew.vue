<template>
    <div class="suggetion-search">
        ...
        <autocomplete
                url="/api/student-search-new/suggest/"
                ...
                :filterByAnchor="true"
                :onShouldGetData="onSearchStudent"
                :onSelect="selectItem">
        </autocomplete>
...
<script>
    ...
    export default {
        props:{
            ...
            responseStudent: Array,
            onSelectStudent: Function,
            beforeSearchStudent: Function,
            afterSearchStudent: Function,
            onSearchStudent: Function,
            componentId: {
              type: String,
              default: 'sugget_contract'
            }
        },
        data () {
            return {
