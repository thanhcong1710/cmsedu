              ...
              <div class="row">
                <div id="demo" class="col-md-3">
                  <div class="form-group">
                    <div class="row">
                      <span class="col-md-5 title-bold">Sản phẩm</span>
                      <select v-model="tuition.product_id" class="col-md-7" id="">
                        <option value="">Lựa chọn sản phẩm</option>
                        <option :value="product.id" v-for="(product, index) in products" :key="index">{{product.name}}</option>
                      </select>
                    </div>
                  </div>
                </div>
                <div class="col-md-9" id="class_tuitions">
                  <div class="col-md-12 info-register fix-boder" id="info">
                    <div class="row">
                      ...
                      <div class="col-md-3 txt-right">
                        <button class="btn btn-info btn-sm">Thêm</button>
                        <button class="btn btn-warning btn-sm">Lưu</button>
                      </div>
                    </div>
                    <div class="row row-boss">
                      ...
                      <div class="col-md-12">
                        <div class="row">
                          ...
                          <span class="col-md-8"><input class="form-control" type="text" /></span>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="row">
                          <span class="col-md-4 title-bold txt-right">Số buổi:</span>
                          <span class="col-md-8"><input type="number" class="form-control" v-model="tuition.session"></span>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="row">
                          ...
                          <span class="col-md-8"><input type="text" class="form-control"></span>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="row">
                          <span class="col-md-4 title-bold txt-right">Ngày bắt đầu hiệu lực:</span>
                          <span class="col-md-8"><input type="date" class="form-control"></span>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="row">
                          ...
                          <span class="col-md-8">
                            <select class="form-control fix-form">
