<template>
    <div class="wrapper">
      <div class="apax-form animated fadeIn">
          <b-row>
            <b-col cols="12">
                <b-card
                header-tag="header"
                footer-tag="footer">
                  <div slot="header">
              <i class="fa fa-clipboard"></i> <strong>Thêm Buổi Học Mới</strong>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="form group">
                          ...
                          <select class="form-control text-select" v-model="session.semester_id" :readonly="show">
                              <option value="" disabled>Chọn kỳ học</option>
                              <option :value="semester.id" v-for="(semester, index) in semesters" :key="index">{{semester.name}}</option>
                          </select>
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" v-model="session.class_name" :readonly="show">
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                          <label class="control-label">Giáo viên</label>
                          <select class="form-control text-select" v-model="session.teacher_id" :readonly="show">
                       ...
                       <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <select class="form-control text-select" v-model="session.room_id" :readonly="show">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <select class="form-control text-select" v-model="session.shift_id" :readonly="show">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-check-group"> 
                              <div class="form-check-left">
                                  <input type="checkbox" value="1" class="form-check-input" v-model="session.weekdays" />
                                  <label class="form-check-label left-check">Thứ 2</label>
                              </div>
                              <div class="form-check-left">
                                  <input type="checkbox" value="2" class="form-check-input" v-model="session.weekdays" />
                                  <label class="form-check-label left-check">Thứ 3</label>
                              </div>
                              <div class="form-check-left">
                                  <input type="checkbox" value="3" class="form-check-input" v-model="session.weekdays" />
                                  <label class="form-check-label left-check">Thứ 4</label>
                              </div>
                              <div class="form-check-left">
                                  <input type="checkbox" value="4" class="form-check-input" v-model="session.weekdays" />
                                  <label class="form-check-label left-check">Thứ 5</label>
                              </div>
                              <div class="form-check-left">
                                  <input type="checkbox" value="5" class="form-check-input" v-model="session.weekdays" />
                                  <label class="form-check-label left-check">Thứ 6</label>
                              </div>
                              <div class="form-check-left">
                                  <input type="checkbox" value="6" class="form-check-input" v-model="session.weekdays" />
                                  <label class="form-check-label left-check">Thứ 7</label>
                              </div>
                              <div class="form-check-left">
                                  <input type="checkbox" value="0" class="form-check-input" v-model="session.weekdays" />
                      ...
                      <div class="col-sm-3">
                          <div class="form-group">
                              ...
                              <div class="form-check-group">
                                  <input type="checkbox" value="0" class="form-check-input" v-model="session.status" />
                      ...
                      <div class="col-sm-3">
                          <div class="form-group">
                              ...
                              <input type="number" value="15" class="form-control" v-model="session.max_students" />
                         </div>
                      </div>
                      <div class="col-sm-3">
                          <div class="form-group">
                              <label class="control-label" title="Người phụ trách">Người phụ trách: </label>
                               <select class="form-control text-select" v-model="session.cm_id" :readonly="show">
                                  <option value="" disabled>Chọn người phụ trách</option>
                                  <option :value="cm.user_id" v-for="(cm, index) in list_cm" :key="index">{{cm.full_name}}</option>
                              </select>
                         </div>
                      </div>
                    </div>
                    <div class="panel-footer">
                      <div class="row">
                        <div class="col-sm-12 col-sm-offset-3 text-right">
                          <button class="apax-btn full edit" type="submit" @click="addSession"><i class="fa fa-save"></i> Lưu</button>
...
export default {
    ...
    return {
      ...
      filter: {
        branch: {
          ...
          display: 'hidden',
          disabled: false,
          placeholder: 'Vui lòng chọn 1 trung tâm'
        },
      },
      datepickerOptions: {
          closed: true,
  ...
  methods: {
    selectBranch(data){
      this.session.branch_id = data.id
      this.show = false
      if (this.session.branch_id){
    ...
    addSession(){
      const session = {
        ...
        class_day: this.session.class_day,
        ...
        start_date: this.getDate(typeof(this.session.timeline[0]) != 'undefined' ? this.session.timeline[0] : ''),
        end_date: this.getDate(typeof(this.session.timeline[1]) != 'undefined' ? this.session.timeline[1] : ''),
      }
      if(session.weekdays == ''){
        ...
        alert("Người phụ trách không để trống")
        return false
    ...
    storeSession(session){
      ...
      u.a().post(`/api/sessions`, data).then(response => {
        this.html.modal.message = "Thêm buổi học thành công!"
