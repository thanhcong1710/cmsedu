                ...
                <div class="row">
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" v-model="contact.name" type="text">
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="form-group">
                      <label class="control-label">Trạng thái</label>
                      <select name="" id="" class="form-control" v-model="contact.status">
              ...
              <div class="panel-footer">
                <div class="row">
                  <div class="col-sm-12 col-sm-offset-3">
                    <button class="btn btn-success" type="submit" @click.prevent="addContact">Lưu</button>
                    <button class="btn btn-default" @click="reset">Hủy</button>
...
<script>
  ...
  export default {
    ...
    methods: {
      addContact() {
        u.a().post(`/api/contacts`, this.contact).then(response => {
          // this.$router.push('/contacts')
          // this.contact.push(response.data.contact);
          this.html.modal.message = "Thêm mới thành công Hình thức liên lạc!"
          this.html.modal.display = true

        });
        console.log(`Add contact ${this.name}`);
      },
      exitModal(){
          this.$router.push('/contacts')
      },
