                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input class="form-control" :value="book.book_id" type="text" readonly>
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label class="control-label">Năm áp dụng</label>
                      <input class="form-control" :value="book.year_apply" type="text" readonly>
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
