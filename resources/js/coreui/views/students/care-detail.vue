                      ...
                      <div class="col-md-6 pad-no">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6 pad-no">
                              <div class="form-group">
                                ...
                                <select class="form-control" v-model="customer_care.contact_method_id" readonly>
                          ...
                          <div class="row">
                            <div class="col-md-6 pad-no">
                              <div class="form-group">
                                ...
                                <select v-model="customer_care.contact_quality_id" @change="changeQuality()"  readonly class="form-control">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <textarea v-model="customer_care.note" class="form-control" rows="4" readonly></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
