    ...
    <div class="row">
      <div class="col-lg-12">
        <b-card header-tag="header">
          <div slot="header">
            <i class="fa fa-file-text"></i> <b class="uppercase"> Thêm mới checkin</b>
          ...
          <div class="panel main-content">
            <div class="panel-body">
              <div class="row">
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input class="form-control" v-model="obj.student.crm_id" disabled placeholder="Sẽ tự động cập nhật khi lưu thông tin học sinh" />
                  </div>
                </div>
              </div>
              <div class="row">
              ...
              <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3 no-padding">
                          <input class="form-control" type="text" placeholder="Họ" v-validate="'required'" v-model="obj.student.gud_firstname1"  @change="genGudName1" name="gud_firstname1" maxlength="200">
                      </div>
                      <div class="col-sm-3 no-padding">
                          <input class="form-control" type="text" placeholder="Đệm" v-model="obj.student.gud_midname1" name="gud_midname1" @change="genGudName1" maxlength="200">
                      </div>
                      <div class="col-sm-3 no-left-padding">
                          <input class="form-control" type="text" placeholder="Tên" v-validate="'required'" v-model="obj.student.gud_lastname1" @change="genGudName1" name="gud_lastname1" maxlength="200">
                      </div>
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input class="form-control"
                           :readonly="(html.data.sibling.id >0 && 1==2) ? true :false"
                           type="text"
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    <label class="control-label">Ngày sinh phụ huynh 1</label>
                    <datePicker
                      id="gud1-birth-day"
                      class="form-control calendar"
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <select class="form-control" v-model="obj.student.source" name="source">
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    <label class="control-label">Ngày/Giờ Checkin<span class="text-danger"> (*)</span></label>
                    <datePicker
                            id="checkin-at"
                            class="form-control calendar"
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input
                      :readonly="html.data.sibling.id >0 ? true :false"
                      class="form-control"
                      type="text"
              ...
              <div class="row">
                <div class="col-sm-4" :class="html.dom.branch.display">
                  <div class="form-group">
                    ...
                    <branch
                      ...
                      :branch-id="this.tmp_branch_id"
                      :onSelect="getUsersByBranch"
                      :options="html.data.branch.list"
                      :disabled="html.dom.branch.disabled"
                      :placeholder="html.dom.branch.placeholder">
                    </branch>
                  </div>
                </div>
                ...
                <div class="col-sm-4" :class="html.dom.ec.display">
                  <div class="form-group">
                    ...
                    <select class="form-control" v-model="obj.student.cm_id" :disabled="html.dom.ec.disabled" name="cm" v-validate data-vv-rules="required">
                ...
                <!-- <div class="col-sm-4">
                  <div class="form-group">
                    <label class="control-label" :class="showEdit()"><span>Click để đánh dấu học thử <input type="checkbox" value="1" v-model="start_trial" @change="startTrialLearing"></span></label>
                    <select class="form-control" :class="html.dom.shift_id.display" v-model="obj.student.shift_id">
    ...
    created() {
      ...
      if (this.$route.query.temp_id){
        u.g(`/api/student-temp/${this.$route.query.temp_id}`)
              .then(response => {
                this.tmp_branch_id = response.data.student.branch_id
                this.obj.student.gud_mobile1 = response.data.student.gud_mobile1
                this.obj.student.name = response.data.student.name
              })
      }
    },
    methods: {
      ...
      reject(msg) {
        this.$notify({
          group: 'apax-atc',
          title: 'Cảnh Báo Dữ Liệu Bị Trùng!',
          type: 'danger',
          duration: 5000,
          text: `Cảnh báo! ${msg}`
        })
      ...
      validateInput() {
        ...
        if (this.obj.student.school_level == '' || this.obj.student.school_level == null) {
          validated = false
        ...
        if (this.obj.student.cm_id == '') {
          validated = false
          alert_msg+= '(*) Chọn CS là bắt buộc<br/>'
        }
        if (this.obj.student.ec_id == '') {
          validated = false
        ...
        this.obj.student.gud_firstname1 = this.obj.student.gud_firstname1.trim()
        if (this.obj.student.gud_firstname1 == '') {
          validated = false
          alert_msg+= '(*) Họ của phụ huynh 1 là bắt buộc<br/>'
        }
        this.obj.student.gud_lastname1 = this.obj.student.gud_lastname1.trim()
        if (this.obj.student.gud_lastname1 == '') {
          validated = false
          alert_msg+= '(*) Tên của phụ huynh 1 là bắt buộc<br/>'
        }
        ...
        // }
        // if (this.obj.student.gud_job1 == '') {
        //   validated = false
        //   alert_msg+= '(*) Nghề nghiệp phụ huynh 1 là bắt buộc<br/>'
        // }
        // if (this.obj.student.gud_email1 == '' || this.obj.student.gud_email1 == null) {
        //   validated = false
        ...
        if (this.obj.student.checkin_at == "0000-00-00 00:00:00" || this.obj.student.checkin_at == null || this.obj.student.checkin_at == '') {
          validated = false
      ...
      checkRequired() {
        ...
        if (this.obj.student.name != '' && this.obj.student.province_id != '' && this.obj.student.gud_mobile1 != '') {
      ...
      store() {
        if (this.validateInput()) {
          ...
          this.obj.student.date_of_birth = this.obj.student.date_of_birth ?this.moment(this.obj.student.date_of_birth, 'DD/MM/YYYY').format('YYYY-MM-DD'):''
          this.obj.student.gud_birth_day1 = this.obj.student.gud_birth_day1 ? this.moment(this.obj.student.gud_birth_day1, 'DD/MM/YYYY').format('YYYY-MM-DD'):''
          this.obj.student.gud_birth_day2 = this.obj.student.gud_birth_day2 ? this.moment(this.obj.student.gud_birth_day2, 'DD/MM/YYYY').format('YYYY-MM-DD'):''
          this.obj.student.checkin_at = this.moment(this.obj.student.checkin_at).format('YYYY-MM-DD HH:mm')
          u.p('/api/checkin/add', this.obj.student).then(response => {
            if (response.success) {
              ...
              let msg_content = `Check in học viên mới:<br/><b>${response.success}</b><br/> đã được lưu thành công!`
      ...
      getDistrict(data = null){
        if (data && typeof data === 'object') {
          ...
          u.g(`/api/provinces/${province_id}/districts`).then(response => {
            ...
            this.obj.student.district_id = ""
            this.obj.student.district = ""

            this.obj.student.school_level = ""
            this.obj.student.school = ""
          })
        }else{
          this.obj.student.province = ""
          this.obj.student.province_id = ""
          this.html.data.district.list = []
          this.obj.student.district = ""
          this.obj.student.district_id = ""
      ...
      checkDublicateStudent(condition, save = false) {
          condition.t = this.moment().toDate().getTime()
          condition.type = 'checkin'
          condition.branch_id = this.obj.student.branch_id
          condition.hub = [80,81].includes(u.session().user.role_id) ? true:false
      ...
      inputSibling(){
        ...
        if (crm_id != '' && (!isNaN(crm_id) || crm_id.length > 4)) {
