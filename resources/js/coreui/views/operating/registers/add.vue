<template>
  <div class="animated fadeIn apax-form apax-show-detail" id="add-enrolments">
    <div class="row">
      <div class="col-lg-12">
        <b-card header-tag="header">
          <div slot="header">
            <i class="fa fa-book"></i> <b class="uppercase">Danh sách đăng ký xếp lớp vào học</b>
            ...
            <div class="col-lg-12">
              <div class="row">
                <div class="col-md-3" id="register-filter">
                  <div class="col-md-12" :class="html.dom.filter.branch.display">
                  ...
                  <div class="col-md-12" :class="html.dom.filter.semester.new.display">
                    <div class="row">
                      ...
                      <div class="col-md-8 filter-selection">
                        <div class="row form-group">
                          <select
                            @change="html.dom.filter.semester.new.action"
                            v-model="data.semester.new.item"
                            :disabled="html.filter.semester.new.disable"
                            class="filter-selection semester form-control"
                          >
                            <option value="">Vui lòng chọn một kỳ học</option>
                            <option :value="semester.id" v-for="(semester, ind) in data.semester.new.list" :key="ind">{{semester.name}}</option>
                          </select>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-12 filter-classes" :class="html.dom.filter.class.new.display">
                    <div class="row">
                      <label class="filter-label control-label">Lớp Học: </label>
                      <div class="row tree-view">
                        <tree
                          :data="data.class.new.list"
                          text-field-name="text"
                          allow-batch
                          @item-click="html.dom.filter.class.new.action"
                        >
                        </tree>
                      </div>
                    </div>
                ...
                <div class="col-md-9" id="register-detail">
                  ...
                  <div class="class-info" :class="html.dom.content.class.display">
                    <div class="col-md-12" >
                      <div class="row">
                        ...
                        <div class="col-md-9 field-detail" >
                          {{ data.class.new.item.class_name }}
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12" >
                      <div class="row">
                        ...
                        <div class="col-md-9 field-detail" >
                          {{ data.class.new.item.class_time }}
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12" >
                      <div class="row">
                        ...
                        <div class="col-md-9 field-detail" >
                          <span v-html="data.class.new.item.teachers_name"></span>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12" >
                      <div class="row">
                        ...
                        <div class="col-md-9 field-detail" >
                          {{ data.class.new.item.total_students, data.class.new.item.class_max_students | totalPerMax }}
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12" >
                      <div class="row">
                        ...
                        <div class="col-md-9 field-detail" >
                          <span v-html="data.class.new.item.time_and_place"></span>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12" >
                      <div class="row">
                        ...
                        <div class="col-md-9 field-detail" >
                          {{ data.class.new.item.cm_name }}
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-12 contracts-list" :class="html.dom.content.contracts.display">
                    <div class="row">
                      <div class="col-md-12" >
                        ...
                        <div class="controller-bar content-heading">
                          <abt
                            :markup="html.dom.button.add.markup"
                            :icon="html.dom.button.add.icon"
                            :label="html.dom.button.add.label"
                            :title="html.dom.button.add.title"
                            :disabled="html.dom.button.add.disabled"
                            :onClick="html.dom.button.add.action"
                            >
                          </abt>
                          <abt
                            :markup="html.dom.button.up.markup"
                            :icon="html.dom.button.up.icon"
                            :label="html.dom.button.up.label"
                            :title="html.dom.button.up.title"
                            :disabled="html.dom.button.up.disabled"
                            :onClick="html.dom.button.up.action"
                            >
                          </abt>
                          <abt
                            :markup="html.dom.button.matrix.markup"
                            :icon="html.dom.button.matrix.icon"
                            :label="html.dom.button.matrix.label"
                            :title="html.dom.button.matrix.title"
                            :disabled="html.dom.button.matrix.disabled"
                            :onClick="html.dom.button.matrix.action"
                            >
                          </abt>
                        </div>
                          ...
                          <table class="table table-striped table-bordered apax-table">
                            ...
                            <tbody>
                              <tr v-for="(student, ind) in cache.students" v-bind:key="ind">
                                ...
                                <td><div v-html="student.enrolment_status | enrolmentStatus"></div></td>
                                <td>{{ student.ec_name }}</td>
                                <td>{{ student.cm_name }}</td>
                                <td>
                                  <span class="apax-btn print">
                                    <i v-b-tooltip.hover title="Nhấp vào để in bản ghi" @click="printForm(student)" class="fa fa-print"></i>
                                  </span>
                                  <span v-if="student.withdraw === 1" class="apax-btn remove">
                                    <i v-b-tooltip.hover title="Nhấp vào để withdraw học sinh này" @click="remove(student)" class="fa fa-remove"></i>
                                  </span>
                                </td>
                              </tr>
                            </tbody>
...
export default {
  ...
  methods: {
    ...
    printForm(data) {
      data.payby_cash = 1
      data.payby_card = 0
      data.payby_transfer = 0
      if (parseInt(data.payment_method) === 1) {
        data.payby_transfer = 1
      }
      this.html.content.print.enrolment = data
      // u.bus.$events.$emit('printEnrolment', data)
    },
    loadSemesters() {
    ...
    selectBranch() {
      this.cache.branch = this.filter.branch
      this.loadSemesters()
    },
    selectSemester() {
