    ...
    <div class="animated fadeIn apax-form">
        <div class="row">
            <div class="col-12">
                ...
                <b-card header>
                    <div slot="header">
                        <i class="fa fa-list"></i> <b class="uppercase">Danh sách hoàn phí </b>
                                ...
                                <table class="table table-striped table-bordered apax-table">
                                    ...
                                    <tr v-for="(withdraw, index) in withdrawal_fees" :key="index">
                                        ...
                                        <td>
                                            ...
                                            <span v-b-tooltip.hover title="Nhấp vào để hoàn phí" class="apax-btn disabled add text-center" v-if="withdraw.status == 1" @click="confirmComplete(withdraw.id)">
                                                <i class="fa fa-usd"></i>
                                            </span>
                                            <span v-b-tooltip.hover title="Nhấp vào để từ chối" class="apax-btn disabled remove text-center" v-if="withdraw.status == 1" @click="confirmDeny(withdraw.id)">
                                                <i class="fa fa-ban"></i>
                                            </span>
                                        </td>
                                    </tr>
                ...
                <b-modal title="Xác nhận" class="modal-primary" size="sm" v-model="approve_modal" @ok="approve" ok-variant="primary">
                    <div>Bạn đã chắc chắn đã hoàn phí này?</div>
                </b-modal>
...
spell.defaults.lang = 'vi'
    ...
    export default {
        ...
        created() {
            let uri = '/api/withdrawals_refun/requests';
        ...
        methods: {
            ...
            approve() {
                ...
                let uri = '/api/withdrawals/'+withdraw_id+'/refun';
            ...
            deny() {
                ...
                let withdraw_id = this.withdraw_id;
                if(cm){
                    let uri = '/api/withdrawals/'+withdraw_id+'/refun-deny';
                    this.flags.form_loading = true;
