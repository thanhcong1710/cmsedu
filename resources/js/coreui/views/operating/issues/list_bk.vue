                          ...
                          <table class="table table-striped table-bordered apax-table">
                            ...
                            <tbody>
                              ...
                              >
                                ...
                                <td>{{ student.student_name }} <br>{{ student.student_nick }}</td>
                              ...
                              <tbody>
                                <tr>
                                  <td width="50%">
                                    <div class="row">
                                      <div class="col-4">
                                        <b class="evaluation-text">Đánh giá chung</b>
                                        <select
                                          name=""
                                          class="form-control"
...
export default {
  ...
  created () {
    ...
    u.a().get(`/api/issues/books/list`).then((response) => {
      ...
      if (l > 0) {
        for (let i = 0; i < l; i++) {
          const b = this.books[i].name
          this.book_list.push(b)
        }
      }
      // console.log('book_list', this.book_list);
      this.checkAvailableBook(this.book_list)
    })
