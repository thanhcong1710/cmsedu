  ...
  >
    <div class="row">
      <div class="col-12">
                              ...
                              >
                                ...
                                <td>
                                  ...
                                  <button
                                    ...
                                    @click="showModalHistory(student)"
                                  >
                                    <i class="fa fa-eye" />
                                  </button>
                                </td>
        ...
        >
          ...
          >
            <div class="row">
              ...
              <div class="col-6">
                <span>{{ modal.student.student_name }}</span>
              </div>
              <div
                class="col-6"
                style="text-align: right"
              ...
              <div class="col-6">
                <span>{{  modal.student.crm_id }}</span>
              </div>
              <div
                class="col-6"
                style="text-align: right"
              ...
              <div class="col-6">
                <span>{{ modal.class.program_name }}</span>
              </div>
              <div
                class="col-6"
                style="text-align: right"
              ...
              <div class="col-6">
                <span>{{ modal.class.class_name }}</span>
              </div>
            </div>
            <br>
            <div
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label">Hình thức liên lạc</label>
                    <div>
                      <select class="form-control" v-model="modal.method">
                          <option value="0">-- Chọn hình thức liên lạc --</option>
                          <option value="1">Nhắn tin</option>
                          <option value="2">Gọi điện thoại</option>
                          <option value="3">Trao đổi trực tiếp</option>
                      </select>
                    </div>
                  </div>
                </div>
                 <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label">Nội dung trao đổi</label>
                    <div>
                      <select class="form-control" v-model="modal.type_content">
                          <option value="0">-- Chọn nội dung trao đổi --</option>
                          <option value="1">Thái độ trong sinh hoạt hàng ngày</option>
                          <option value="2">Tình hình học tập</option>
                          <option value="3">Bài tập</option>
                          <option value="4">Định hướng</option>
                          <option value="5"> Nghỉ học/học bù</option>
                          <option value="6">Ngưng học</option>
                          <option value="7">Hạng mục thông báo chung</option>
                          <option value="8">Chuyển lớp</option>
                          <option value="9">Thành tích học tập</option>
                          <option value="10">Học sinh mới nhập học</option>
                          <option value="11">Test cuối kỳ</option>
                          <option value="12">Quan hệ bạn bè</option>
        ...
        <b-modal
          size="lg"
          title='Nội dung chăm sóc học sinh'
          class="modal-primary"
          v-model="modal_history.display"
          id="add-feedback"
          hide-footer
        >
          <div class="animated fadeIn apax-form"
          >
            <div class="row">
              ...
              <div class="col-6">
                <span>{{ modal_history.student.student_name }}</span>
              </div>
              <div
                class="col-6"
                style="text-align: right"
              ...
              <div class="col-6">
                <span>{{  modal_history.student.crm_id }}</span>
              </div>
              <div
                class="col-6"
                style="text-align: right"
              ...
              <div class="col-6">
                <span>{{ modal_history.class.program_name }}</span>
              </div>
               <div
                class="col-6"
                style="text-align: right"
              ...
              <div class="col-6">
                <span>{{ modal_history.class.level_name }}</span>
              </div>
              <div
                class="col-6"
                style="text-align: right"
              ...
              <div class="col-6">
                <span>{{ modal_history.class.class_name }}</span>
              </div>
            </div>
            <br>
            <div
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <table class="table table-striped table-bordered apax-table">
                    ...
                    <tbody>
                      <tr
                        v-for="(log, ind) in modal_history.logs"
                        :key="ind"
                      >
                        <td align="right">
                          {{ ind + 1 }}
                        ...
                        <td>{{ log.creator_name }} - {{log.role_name}}</td>
                        <td>{{ log.method_show }}</td>
                        <td>{{ log.type_content_show }}</td>
                        <td>{{ log.note }}</td>
                        <td>{{ log.updated_at }}</td>
                        <td>
                          <button
                            class="btn btn-sm btn-success"
                            @click="showModalEdit(log)"
                          >
                            <i class="fa fa-edit" />
                          </button>
                        </td>
        ...
        <b-modal
          size="lg"
          title='Cập nhật nhận xét học sinh'
          class="modal-primary"
          v-model="modal_edit.display"
          id="add-feedback"
          hide-footer
        >
          <div class="animated fadeIn apax-form"
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label">Hình thức liên lạc</label>
                    <div>
                      <select class="form-control" v-model="modal_edit.method">
                          <option value="0">-- Chọn hình thức liên lạc --</option>
                          <option value="1">Nhắn tin</option>
                          <option value="2">Gọi điện thoại</option>
                          <option value="3">Trao đổi trực tiếp</option>
                 ...
                 <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label">Nội dung trao đổi</label>
                    <div>
                      <select class="form-control" v-model="modal_edit.type_content">
                          <option value="0">-- Chọn nội dung trao đổi --</option>
                          <option value="1">Thái độ trong sinh hoạt hàng ngày</option>
                          <option value="2">Tình hình học tập</option>
                          <option value="3">Bài tập</option>
...
export default {
  ...
  methods: {
    ...
    handleCreateFeedback (student, readOnly) {
      ...
      this.modal.class=this.cache.class_info
      this.modal.method=''
      this.modal.type_content=''
      this.modal.note=''
    },
    handleCloseModal(){
    ...
    saveStudentCare(){
      if(!this.modal.method){
        alert('Vui lòng chọn hình thức liên lạc.')
        return false;
      }
      if(!this.modal.type_content){
        alert('Vui lòng chọn nội dung trao đổi.')
        return false;
      }
      if(!this.modal.note){
        alert('Vui lòng nhập nhận xét chung')
        return false;
      }
       const data = {
          student_id:this.modal.student.student_id,
          class_id : this.modal.class.class_id,
          method : this.modal.method,
          type_content  : this.modal.type_content,
          note: this.modal.note,
        }
        this.handleCloseModal()
        this.action.loading=true
        u.p('/api/issues/add-student-care', data)
          .then((response) => {
            this.action.loading=false
            alert('Tạo nhận xét thành công')
          })
    },
    showModalHistory(student) {
      this.modal_history.display =true
      this.modal_history.student= student
      this.modal_history.class=this.cache.class_info
      this.action.loading=true
      u.g('/api/issues/get-student-care/'+ this.modal_history.student.student_id)
        .then((response) => {
          this.action.loading=false
         this.modal_history.logs =response
        })
    },
    showModalEdit(log){
      this.modal_edit.display =true
      this.modal_edit.log_id= log.id
      this.modal_edit.method=log.method
      this.modal_edit.type_content=log.type_content
      this.modal_edit.note=log.note
      this.modal_edit.student_id=log.student_id
    },
    closeModalEdit(){
      this.modal_edit.display =false
    },
    editStudentCare(){
      if(!this.modal_edit.method){
        alert('Vui lòng chọn hình thức liên lạc.')
        return false;
      }
      if(!this.modal_edit.type_content){
        alert('Vui lòng chọn nội dung trao đổi.')
        return false;
      }
      if(!this.modal_edit.note){
        alert('Vui lòng nhập nhận xét chung')
        return false;
      }
       const data = {
          log_id : this.modal_edit.log_id,
          method : this.modal_edit.method,
          type_content  : this.modal_edit.type_content,
          note: this.modal_edit.note,
        }
         this.modal_edit.display =false
        this.action.loading=true
        u.p('/api/issues/edit-student-care', data)
          .then((response) => {
            alert('Cập nhật thành công')
             u.g('/api/issues/get-student-care/'+ this.modal_edit.student_id)
              .then((response) => {
                this.action.loading=false
              this.modal_history.logs =response
            })
