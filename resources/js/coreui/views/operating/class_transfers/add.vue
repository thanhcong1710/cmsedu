                                                ...
                                                <div class="col-12 pad-no">
                                                    <div class="form-group">
                                                        ...
                                                        <branch                                                        
                                                            ...
                                                            :options="branch_list"
                                                            v-model="branch_info" 
                                                            @input="selectTransferringBranch"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" :value="data.contract.total_charged | formatMoney" type="text" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" :value="data.temp.transferring.amount_left | formatMoney" type="text" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" :value="data.temp.transferring.amount_transferred | formatMoney" type="text" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" v-model="data.temp.receiving.amount_received" type="text" :readonly="html.receiving.form_fields.amount_received.readonly" @keyup="editAmountReceived">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
        ...
        methods: {
            ...
            selectTransferDate(selected_date) {
                ...
                if (date !== "" && date !=="Invalid date") {
                    if (this.flags.requesting === false) {
                        if ( !this.isReserved( date,this.data.contract.reserved_dates)){
                            if (this.data.temp.receiving.class_days.length) {
                                ...
                                this.data.temp.receiving.start_date = this.data.temp.receiving.new_enrol_start_date
                            ...
                            let message = u.genErrorHtml("Học sinh chưa kết thúc thời gian bảo lưu không được phép chuyển lớp")
                            this.showMessage(message)
                        }
                    }
                }
            ...
            searchContract(student_name){
                if(student_name.length > 2){
                    let url = '/api/class-transfers/suggest/' + (student_name?student_name:'_') + '/' + this.data.temp.transferring.branch_id + '/1';
            ...
            selectContract(contract){
                if(contract.waiting_status==0){
                    ...
                    if((parseInt(contract.payload) == 1) && (parseInt(contract.total_charged) < parseInt(contract.must_charge))){
                        this.html.receiving.form_fields.enable_editor.show = false;
                    }else{
                        this.html.receiving.form_fields.enable_editor.show = true;
                    }
                    ...
                    if(moment(now) <= moment(contract.start_date)){
                        ...
                        this.data.temp.transferring.amount_left = contract.total_charged;
                    }else{
                        let done_sessions = u.calSessions(contract.start_date, u.pre(now), this.data.contract.holidays, this.data.contract.class_days).total;
                        ...
                        this.data.temp.transferring.amount_left = Math.ceil(this.data.temp.transferring.number_of_session_left * contract.total_charged / contract.real_sessions);
                    }

                    this.setMinDate(contract);
                    this.data.temp.receiving.max_date = moment(this.data.contract.end_date).subtract(1,'d').format('YYYY-MM-DD');
                    u.log(this.data.temp.receiving.max_date);
            ...
            selectClass(item){
                ...
                this.getNearestSchoolDay(_.get(this, 'data.contract.contract_id'), _.get(this, 'data.contract.class_id'));
            },
            getNearestSchoolDay(contractId, classId){
                this.flags.requesting = true
              u.g(`/api/classes/get-nearest-school-day/${classId}/${contractId}`).then((response) => {
                ...
                this.data.temp.receiving.max_date = nearestSchoolDay === currentDay ? nearestSchoolDay : preNearestSchoolDay
            ...
            reset(){
                ...
                this.html.calendar.disabled = true
                this.html.receiving.form_fields.note.readonly = true
            },
            resetLearningInfo(){
            ...
            validate(){
                ...
                if(isNaN(this.data.temp.receiving.amount_received) || parseInt(this.data.temp.receiving.amount_received) < 0){
                    resp.valid = false;
                    resp.message += u.genErrorHtml('Số tiền quy đổi không hợp lệ');
                }
                ...
                let class_days_string = JSON.stringify(this.data.contract.class_days);
                let check_string_1 = JSON.stringify([0,6]);
                let check_string_2 = JSON.stringify([6,0]);
                if(this.is2017Contract() && ((class_days_string == check_string_1) || (class_days_string == check_string_2)) && ((this.data.temp.transferring.shift_checked === false) || (this.data.temp.transferring.shift_checked === 0))){
                    resp.valid = false;
                    resp.message += u.genErrorHtml('Vui lòng đọc ghi chú');
                }

                return resp;
            },
            setMinDate(enrolment){
                // for(let i in enrolment.reserved_dates){
                //     if(!this.isGreaterThan(this.data.temp.receiving.min_date, enrolment.reserved_dates[i].end_date)){
                //         this.data.temp.receiving.min_date = moment(enrolment.reserved_dates[i].end_date).add(1, 'days');
                //     }
                // }
            },
            isReserved(date, reserve_dates) {
                let reserved = false;

                if (reserve_dates.length) {
                    for (var i in reserve_dates) {
                        if ((moment(date) < moment(reserve_dates[i].end_date)) ) {
                        reserved = true;
                        break;
                        }
                    }
