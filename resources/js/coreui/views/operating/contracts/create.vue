    ...
    <div class="animated fadeIn apax-form" @click="html.dom.action.page">
        <div class="row">
            <div class="col-12">
                ...
                <b-card header>
                    <div slot="header">
                        <i class="fa fa-id-card"></i> <b class="uppercase">Nhập học cho học sinh mới</b>
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                       :value="student.ec_name" type="text"
                                                                       readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                       :value="student.ec_leader_name" type="text"
                                                                       readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                       :value="student.ceo_branch_name" type="text"
                                                                       readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-6 pad-no" :class="html.config.style">
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="filter-label control-label">Chọn Loại Khách Hàng</label><br/>
                                                                    <select
                                                                        ...
                                                                        :disabled="html.dom.disabled.customer_type"
                                                                        v-model="data.customer_type"
                                                                        @change="html.dom.action.customer_type(data.customer_type)">
                                                        ...
                                                        <div class="col-md-6" :class="html.dom.display.receive">
                                                            <div class="form-group checkbox-inrow">
                                                                <label class="control-label">Chỉ nhận chuyển phí</label>
                                                ...
                                                <div class="col-md-12 select-tuition-fee" :class="html.dom.display.tuition_fee">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label v-b-tooltip.hover
                                                                       ...
                                                                       class="control-label">Số tiền giảm trừ tích điểm
                                                                    (Trừ sau chiết khấu)</label>
                                                                <input :disabled="html.dom.disabled.point"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label v-b-tooltip.hover
                                                                            ...
                                                                            Voucher</label>
                                                                        <input :disabled="html.dom.disabled.voucher"
                                                                               class="form-control" type="text"
                                                ...
                                                <div class="col-md-12 pad-no">
                                                    <div class="form-group expected-class">
                                                        ...
                                                        <input :disabled="html.dom.disabled.expected_class"
                                                               class="form-control" type="text"
    ...
    export default {
        ...
        methods: {
            start() {
                ...
                u.g(`/api/contracts/load/student/${this.$route.params.id}`)
                .then(response => {
                    if (response) {
                        this.data.branch = parseInt(response.branch_id)
            ...
            calculateDiscount() {
                ...
                this.data.total_point_sibling = the_point.n + the_sibling.n
                ...
                this.data.must_charge_amount = this.data.discounted_amount - this.data.total_voucher_other
            ...
            recalculateDiscount() {
                ...
                if (this.data.must_charge_amount < 0) {
                    ...
                    this.data.bill_info += `Tích Điểm: ${the_point.s}<br/>`
                    this.data.detail += `Giảm trừ Thẻ Tích Điểm: ${the_point.s}\n`
                    }
                    ...
                    if (parseInt(this.data.total_voucher_other, 10) + parseInt(this.data.total_point_sibling, 10)) {
                        this.data.detail += `------------------------------\nTổng khấu trừ: ${this.format(parseInt(this.data.total_voucher_other))}\n`
                        this.data.detail += `\nSố tiền còn lại phải đóng:\n ${this.data.discounted_amount} - ${this.format(parseInt(this.data.total_voucher_other))}\n------------------------------\n = ${this.data.must_charge}`
                    }
                }
            },
            ...
            selectStudent(student) {
                ...
                .then(response => {
                    if (response) {
                        ...
                        /***** Logic change on 21/07/2018 (old: +1 sesssion -> new: +1 day) *****/
                        if (response.information.latest_contract && response.information.latest_contract.type === 0) {
                            this.data.start_date = this.moment(response.information.latest_contract.start_date).add(8, 'days').format('YYYY-MM-DD')
                        } else {
                            this.data.start_date = response.information.latest_date && response.information.latest_date != this.moment().format('YYYY-MM-DD') ? this.moment(response.information.latest_date).add(1, 'days').format('YYYY-MM-DD') : this.moment().format('YYYY-MM-DD')
                        }
                        if (response.information.latest_contract && response.information.latest_contract.status === 7) {
                            this.data.start_date = this.moment(response.information.latest_contract.end_date).add(1, 'days').format('YYYY-MM-DD')
                        }
                        if (response.information.latest_contract && response.information.latest_contract.type === 0
                        && response.information.latest_contract && response.information.latest_contract.last_date) {
                            this.data.start_date = this.moment(response.information.latest_contract.last_date).add(1, 'days').format('YYYY-MM-DD')
                        }
                        /***** End change on 21/07/2018 (old: +1 sesssion -> new: +1 day) *****/
                        this.data.previous_date = this.moment(this.data.start_date).format('YYYY-MM-DD')
                        this.selectStartDate(this.data.start_date)
                        this.html.dom.list.product = response.products
                        this.student = response.student
            ...
            selectCustomerType(customer_type_id) {
                ...
                this.program = ''
                this.resetMinForm()
                this.data.customer_type = parseInt(customer_type_id, 10)
                ...
                // } else if (customer_type_id === 0 || customer_type_id === '0') {
                //     this.toggleButtonsBar(1)
                //     this.receive = false
            ...
            selectProgram(program_id) {
                ...
                this.data.tuition_fee = ''
                this.tuition_fee = ''
                if (this.data.customer_type === 0 || this.data.customer_type === '0' || this.data.customer_type === '') {
                    this.hideCalculationObjects()
                    this.html.dom.disabled.tuition_fee = true
            ...
            selectTuitionFee(tuition_fee_id) {
                ...
                if (this.data.latest_contract) {
                    ...
                    if (parseInt(this.program) === parseInt(this.data.latest_contract.program_id)) {
            ...
            validate() {
                ...
                let resp = true
                if (!this.receive) {
                    if ((!this.data.product || parseInt(this.data.product.product_id,10) === 0) && parseInt(this.data.customer_type, 10) === 1) {
           ...
           storeContract(data) {
                ...
                data.student.lms_id = data.lms_id
                data.student.accounting_id = data.accounting_id
                u.p('/api/contracts/add', data)
                .then(response => {
                    const inserted_contract = response
                    this.completed = true
                    this.html.config.modal = true
                    this.html.loading.action = false
                    this.html.loading.class = false
                    u.apax.$emit('apaxPopup', {
                        on: true,
                        content: `Biên bản nhập học trải nghiệm của học viên <br/><b>${inserted_contract.name}</b><br/> đã được lưu thành công.<br/><b style="color:red;"><i>Nếu bạn muốn thực hiện xếp lớp luôn xin vui lòng nhấn vào nút "OK".</i></b><br/><i>Hoặc không, hãy nhấp vào dấu "X" góc trên bên phải để trở lại danh sách học sinh.</i>`,
                        title: 'Thông Báo',
                        class: 'modal-success',
                        size: 'md',
                        confirm: {
            ...
            resetForm(all = true) {
                ...
                if (all) {
                    ...
                    this.$router.push('/contracts/add')
                }
            },
