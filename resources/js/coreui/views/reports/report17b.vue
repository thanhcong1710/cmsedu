<template>
    <div class="wrapper">
      <div class="animated fadeIn">
        <b-row>
            <b-col cols="12">
              <b-card
                ...
                footer-tag="footer">
                  <div slot="header">
              <strong>BC17B - Báo cáo phân loại trung tâm</strong>
                    ...
                    <div class="row">
                      ...
                      <div class="col-8">
                          <div class="row">
                            ...
                            <div class="col-9 form-group">
                             <div class="row">
                               ...
                               <div class="col-2"><button :disabled="disabledSelectBranch" class="btn btn-info btn-print" @click="showBC17bModal">...</button></div>
                             </div>
                            </div>
                          </div>
                          ...
                          <div class="row input-number">
                            <div class="col-7">
                              <div class="row">
                                <div class="col-5"><strong>Best Branches</strong></div>
                                <div class="col-6">
                                  <input type="number" v-model="best_branches" class="form-control input-text-left" placeholder="Best branches...">
                                </div>
                              </div>
                            </div>
                            <div class="col-5">
                              <div class="row">
                                <div class="col-5"><strong>Worst Branches</strong></div>
                                <div class="col-7">
                                  <input type="number" v-model="worst_branches" class="form-control input-text-right" placeholder="Worst branches...">
                                </div>
                              </div>
                            </div>
                          </div>
        ...
        <b-row>
          <b-col cols="12">
            <b-card
              ...
              <div class="content-detail">
                <button class="btn btn-success button-print" @click="printReportBC17b"><i class="fa fa-print"> &nbsp;Xuất báo cáo</i></button>
        ...
        <!-- the modal below -->
        <b-modal size="lg" id="showBC17b" hide-header class="add-branchs" v-model="showBC17b">
  ...
  methods: {
    ...
    viewPrintInfo(){
      const data = {
        ...
        best_branches: this.best_branches,
        worst_branches: this.worst_branches
      }
      u.a().post(`/api/reports/form-17b`, data).then(response => {
    ...
    printReportBC17b(){
      ...
      var best = this.best_branches
      var worst = this.worst_branches
      ...
      var p =`/api/exel/print-report-bc17b/${br}/${fd}/${td}/${best}/${worst}`
