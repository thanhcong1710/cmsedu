      ...
      <b-row>
        <b-col cols="12">
          <b-card
                  ...
                  footer-tag="footer">
            <div slot="header">
              <strong>BC03 - Báo cáo học sinh mới hàng tháng</strong>
            ...
            <div class="content-detail">
              ...
              <div slot="footer" class="text-center">
                ...
                <button class="apax-btn full print" @click="printReportBC03">
    ...
    export default {
        ...
        methods: {
            ...
            printReportBC03(){
              ...
              var p =`/api/exel/print-report-bc03/${br}/${pd}/${pro}/${fd}/${td}`
            ...
            viewPrintInfo() {
                ...
                u.a().post(`/api/reports/form-03`, data).then(response => {
