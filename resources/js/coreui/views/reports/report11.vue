      ...
      <b-row>
        <b-col cols="12">
          <b-card
                  ...
                  footer-tag="footer">
            <div slot="header">
              <strong>BC11 - Báo cáo chuyển lớp/ chuyển trung tâm</strong>
            ...
            <div class="content-detail">
              ...
              <div slot="footer" class="text-center">
                ...
                <button class="apax-btn full print" @click="printReportBC11">
    ...
    export default {
        ...
        methods: {
            ...
            printReportBC11(){
              ...
              var p =`/api/exel/print-report-bc11/${br}/${pd}/${pro}/${cuzType}/${fd}/${td}`             
              window.open(p, '_blank')
              if(extraWindow){
                  extraWindow.location.reload();
              }
            ...
            viewPrintInfo() {
                ...
                u.a().post(`/api/reports/form-11`, data).then(response => {
