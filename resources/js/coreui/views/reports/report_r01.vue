      ...
      <div class="col-12">
        <b-card header>
          <div slot="header">
            ...
            <strong>BÁO CÁO KHÁCH SALES HUB LÊN GÓI PHÍ TẠI TRUNG TÂM - Tổng số: {{pagination.total}}</strong>
          </div>
            ...
            >
              ...
              <tbody>
                <tr v-for="(item, index) in dataReport" :key="index">
                  ...
                  <td>{{item.creator_checkin_name}}</td>
...
export default {
  ...
  methods: {
    ...
    exportExcel() {
      ...
      var urlApi = "/api/export/report_r01"
      var tokenKey = u.token()
      u.g(urlApi, params, 1, 1)
        .then(response => {
          saveAs(response, "THÔNG TIN KHÁCH SALES HUB LÊN GÓI PHÍ TẠI TRUNG TÂM.xlsx");
          this.processing = false;
        })
        .catch(e => {
          this.processing = false;
