<template>
    <div class="wrapper">
      <div class="animated fadeIn">
        <b-row>
            <b-col cols="12">
              <b-card
                ...
                footer-tag="footer">
                  <div slot="header">
              <strong>BC17D - Báo cáo doanh số theo Team</strong>
                    ...
                    <div class="row">
                      ...
                      <div class="col-8">
                          <div class="row">
                            ...
                            <div class="col-9 form-group">
                             <div class="row">
                               ...
                               <div class="col-2"><button :disabled="disabledSelectBranch" class="btn btn-info btn-print" @click="showBC17dModal">...</button></div>
                             </div>
                            </div>
                          </div>
                          ...
                          <div class="row input-number">
                            <div class="col-7">
                              <div class="row">
                                <div class="col-5"><strong>Best Teams</strong></div>
                                <div class="col-6">
                                  <input type="number" @input="disableGoodSale" v-model="best_teams" :disabled="this.disableGoodEc" class="form-control input-text-left" placeholder="Best Teams...">
                                </div>
                              </div>
                            </div>
                            <div class="col-5">
                              <div class="row">
                                <div class="col-5"><strong>Worst Teams</strong></div>
                                <div class="col-7">
                                  <input type="number" v-model="worst_teams" :disabled="this.disableBadEc" @input="disableBadSale" class="form-control input-text-right" placeholder="Worst Teams...">
                                </div>
                              </div>
                            </div>
                          </div>
        ...
        <b-row>
          <b-col cols="12">
            <b-card
              ...
              <div class="content-detail">
                <button class="btn btn-success button-print" @click="printReportBC17d"><i class="fa fa-print"> &nbsp;Xuất báo cáo</i></button>
                  ...
                  <table class="table table-striped table-bordered apax-table">
                      ...
                      <tbody>
                        <tr v-for="(item, index) in results" :key="index">
                          ...
                          <td>{{item.summary|formatCurrency2}}</td>
                          <td>{{item.type}}</td>
                        </tr>
                      </tbody>
                  </table>
        ...
        <!-- the modal below -->
        <b-modal size="lg" id="showBC17d" hide-header class="add-branchs" v-model="showBC17d">
  ...
  methods: {
    ...
    viewPrintInfo(){
      const data = {
        ...
        best_teams: this.best_teams,
        worst_teams: this.worst_teams
      }
      u.a().post(`/api/reports/form-17d`, data).then(response => {
    ...
    printReportBC17d(){
      ...
      var p =`/api/exel/print-report-bc17d/${br}/${fd}/${td}/${bestLead}/${worstLead}/${bestStaff}/${worstStaff}`
