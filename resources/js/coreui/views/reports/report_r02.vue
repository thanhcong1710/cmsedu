      ...
      <div class="col-12">
        <b-card header>
          <div slot="header">
            ...
            <strong>BÁO CÁO KHÁCH MARKETING LÊN GÓI PHÍ TẠI TRUNG TÂM - Tổng số: {{pagination.total}}</strong>
          </div>
...
export default {
  ...
  methods: {
    ...
    exportExcel() {
      ...
      var urlApi = "/api/export/report_r02"
      var tokenKey = u.token()
      u.g(urlApi, params, 1, 1)
        .then(response => {
          saveAs(response, "THÔNG TIN KHÁCH MARKETING LÊN GÓI PHÍ TẠI TRUNG TÂM.xlsx");
          this.processing = false;
        })
        .catch(e => {
          this.processing = false;
