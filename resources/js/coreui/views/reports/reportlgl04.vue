      ...
      <div class="col-12">
        <b-card header>
          <div slot="header">
            ...
            <strong>BÁO CÁO CHI TIẾT GÓI BÁN - Tổng số: {{pagination.total}}</strong>
          </div>
            ...
            >
              ...
              <tbody>
                <tr v-for="(item, index) in dataReport" :key="index">
                  ...
                  <td>{{ item.count_recharge == 0 ? 'Bán mới' : 'Tái tục' }}</td>
...
export default {
  ...
  methods: {
    ...
    exportExcel() {
      ...
      var urlApi = "/api/export/lgl04"
      var tokenKey = u.token()
      u.g(urlApi, params, 1, 1)
        .then(response => {
          saveAs(response, "Báo cáo chi tiết gói bán.xlsx");
          this.processing = false;
        })
        .catch(e => {
          this.processing = false;
