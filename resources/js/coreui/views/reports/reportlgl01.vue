        ...
        <b-card header>
          ...
          <div class="content-detail">
            <div class="row">
              ...
              <div class="col-md-3">
                <select class="form-control" v-model="searchData.typeProduct">
                  <option value="0">LogicMath</option>
      ...
      <div class="col-12">
        <b-card header>
          <div slot="header">
            ...
            <strong>BÁO CÁO HỌC SINH HẾT PHÍ - Tổng số: {{pagination.total}}</strong>
          </div>
  ...
  methods: {
    ...
    exportExcel() {
      ...
      u.g(urlApi, params, 1, 1)
        .then(response => {
          saveAs(response, "Báo cáo học sinh hết phí.xlsx");
          this.processing = false;
        })
        .catch(e => {
          this.processing = false;
    ...
    getParamsSearch() {
      ...
      const data = {
        ...
        type_product: this.searchData.typeProduct,
      };
      return data;
    },
    clearSearch() {
