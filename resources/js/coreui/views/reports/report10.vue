      ...
      <b-row>
        <b-col cols="12">
          <b-card
                  ...
                  footer-tag="footer">
            <div slot="header">
              <strong>BC10 - Báo cáo doanh số</strong>
            ...
            <div class="content-detail">
              ...
              <div slot="footer" class="text-center">
                ...
                <button class="apax-btn full print" @click="printReportBC10">
                ...
                <table class="table table-striped table-bordered apax-table">
                      <thead>
                        <tr class="text-sm">
                          ...
                          <th>Trung tâm</th>
                          <th>Doanh số</th>
                          <th>Doanh số trong ngày</th>
                          <th>Doanh số kế hoạch</th>
                          <th>% kế hoạch</th>
                          <th>Số học sinh mới</th>
                          <th>Số học sinh hiện tại</th>
                          <th>Số học sinh hết hạn</th>
                          <th>Số học sinh còn nợ</th>
                        </tr>
                      </thead>
                      <tbody>
    ...
    export default {
        ...
        methods: {
            ...
            printReportBC08(){
              ...
              var p =`/api/exel/print-report-bc08/${br}/${pd}/${pro}/${fd}/${td}`
            ...
            printReportBC10(){
              ...
              var cuzType = ''
              for (var p in this.student_types_selected){
                cuzType += this.student_types_selected[p].id+','
              }
              ...
              var p =`/api/exel/print-report-bc10b/${br}/${pd}/${pro}/${cuzType}/${fd}/${td}/${type}`             
              window.open(p, '_blank')
              if(extraWindow){
                  extraWindow.location.reload();
              }
            ...
            viewPrintInfo() {
                ...
                const data = {
                    ...
                    customerType: this.student_types_selected,
                ...
                u.a().post(`/api/reports/form-10`, data).then(response => {
