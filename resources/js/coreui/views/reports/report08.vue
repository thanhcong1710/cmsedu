      ...
      <b-row>
        <b-col cols="12">
          <b-card
                  ...
                  footer-tag="footer">
            <div slot="header">
              <strong>BC08 - Phân loại CM</strong>
            ...
            <div class="content-detail">
              ...
              <div slot="footer" class="text-center">
                ...
                <button class="apax-btn full print" @click="printReportBC08">
                ...
                <table class="table table-striped table-bordered apax-table">
                      ...
                      <tbody>
                        <tr v-for="(item, index) in results" :key="index">
                          ...
                          <td>{{item.lms_id}}</td>
                          <td>{{item.rating_creator_name}}</td>
    ...
    export default {
        ...
        methods: {
            ...
            viewPrintInfo() {
                ...
                u.a().post(`/api/reports/form-08`, data).then(response => {
