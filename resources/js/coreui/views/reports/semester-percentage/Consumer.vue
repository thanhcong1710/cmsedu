            ...
            <b-row>
                <b-col cols="12">
                    <b-card
                            ...
                            footer-tag="footer"
                            >
                        <header-report title="Báo cáo tỉ lệ theo chương trình học " />
                ...
                <b-col cols="12">
                    <b-card
                        ...
                        <div slot="header">
                            ...
                            <strong>Báo cáo tỉ lệ theo chương trình học  {{ type && type.value === 0 ? "hàng ngày": "hàng tháng" }}</strong>
                        </div>
                        <div class="content-detail">
                                ...
                                <table v-if="state.students" class="table table-striped table-bordered apax-table">
                                    <tr>
                                        ...
                                        <template v-if="state.students.month"  v-for="m in state.students.month">
                                            <th colspan="7">{{state.students.dates[m]}}</th>
                                        </template>
                                    ...
                                    <tr>
                                        ...
                                        <template v-if="state.students.month"  v-for="m in state.students.month">
                                            <template v-for="(label, lb) in state.students.label">
                                                <td v-if="label.id <= 4">{{getTuition(state.students.tuition,m,lb,index,'list')}}</td>
                                                <td v-if="label.id >4">{{getTuition(state.students.tuition,m,lb,index,'percentage')}}</td>
                                            </template>
                                    ...
                                    <template v-if="state.students"  v-for="s in 1">
                                        <tr>
                                            ...
                                            <template v-if="state.students.month"  v-for="m in state.students.month">
                                                <template v-for="(label, lb) in state.students.label">
                                                    <td v-if="label.id <= 4">{{getTuitionSum(state.students.sum,m,lb,s,'list')}}</td>
                                                    <td v-if="label.id >4">{{getTuitionSum(state.students.sum,m,lb,s,'percentage')}}</td>
                                                </template>
